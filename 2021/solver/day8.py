...
def decode_entry(entry):
    ...
    segments[2] = list(decoded_patterns[4] - decoded_patterns[1] - set((segments[4])))[
        0
    ]
    ...
    segments[5] = list(
        decoded_patterns[8]
        - decoded_patterns[1]
        - set((segments[1], segments[2], segments[4], segments[7]))
    )[0]
    ...
    segments[6] = list(
        candidate_segments - set((segments[1], segments[2], segments[4], segments[7]))
    )[0]
